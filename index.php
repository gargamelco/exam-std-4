...
<meta charset="utf-8">
<meta name="description" content="Информационни технологии бъдещето е в нас">
<meta name="keywords" content="технологии, бъдеще, информационни, софтуер, мрежи">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<link href="styles/layout.css" rel="stylesheet" type="text/css" media="all">
</head>
<body id="top">
<header class="wrapper row0">
...
<div class="wrapper bgded overlay">
  <section id="pageintro" class="hoc clear"> 
    <article>
      ...
      <h2 class="heading orange"><span class="block">Бъдещето е в </span> НАС !</h2>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace d-none">&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<section class="wrapper bgded overlay bg2">
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="C# and .NET"></a>
        ...
        <hr>
        <p class="text-justify">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
        <p class="nospace"><a href="#">Read More &raquo;</a></p>
      </article>
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="not found"></a>
        <h4 class="nospace btmspace-10 font-x1 uppercase">Езикът C# и платформата .NET</h4>
        <ul class="nospace btmspace-10 group font-xs">
          <li class="fl_left">
        ...
        <hr>
        <p class="text-justify">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="not found"></a>
        ...
        <hr>
        <p class="text-justify">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
