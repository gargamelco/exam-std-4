...
<body id="top">
    ...
    <div class="wrapper bgded overlay" id="sidebar-first-div">
    ...
    <div class="wrapper row3">
        <main class="hoc container clear">
            ...
            <div class="sidebar one_quarter">
                ...
                <div id="sidebar-second-div" class="sdb_holder">
                    <ul id="sidebar-second-ul">
